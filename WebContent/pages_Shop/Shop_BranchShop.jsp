					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="actions">
									<button id="sample_editable_1_new" onclick="location.href='BranchShop_Add.jsp'" class="btn red">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_2">
									...
									<tbody>									
										<s:iterator value="#BranchShop" var="p">
										<tr class="">
											<td><s:property value="#p.BranchShop_Id" /></td>
											<td><s:property value="#p.BranchShop_Name" /></td>
											<td><s:property value="#p.BranchShop_Adress" /></td>
											<td>
												<!-- begin操作按钮 -->
												<div class="btn-group" style="margin-bottom: 0px !important;">
													...
													<ul class="dropdown-menu">
														...
														<li><a data-toggle="modal"
															href="BranchShop!update?brancheShop.BranchShop_Id=<s:property value="#p.BranchShop_Id" />">
															<i class="icon-edit"></i>编辑</a></li>
														<li><a onclick="return confirm('确定删除该数据吗?');" href="BranchShop!deleteBranchShop?brancheShop.BranchShop_Id=<s:property value="#p.BranchShop_Id" />">
