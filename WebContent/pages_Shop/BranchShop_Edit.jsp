					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>修改店铺数据
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="BranchShop!updateBrancheShop" method="post" class="form-horizontal">
									<h3 class="form-section">店铺数据</h3>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												<label class="control-label">店铺名：</label>
												<input name="brancheShop.BranchShop_Id" type="hidden" width="200px" value="<s:property value="#Shopp.BranchShop_Id" />"/>
												<input name="brancheShop.BranchShop_Name" type="text" width="200px" value="<s:property value="#Shopp.BranchShop_Name" />"/>
											</div>
										</div>
										<!--/span-->
									</div>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="brancheShop.BranchShop_Adress" type="text" width="200px" value="<s:property value="#Shopp.BranchShop_Adress" />"/>
												</div>
											</div>
										</div>
										<!--/span-->
