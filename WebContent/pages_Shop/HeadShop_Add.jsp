					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="HeadShop!addHeadShop" method="post" class="form-horizontal">
									<h3 class="form-section">总店数据</h3>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												<label class="control-label">店铺名：</label>
												<input name="headShop.Shop_Name" type="text" width="200px"  />
											</div>
										</div>
										<!--/span-->
									</div>
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="headShop.Shop_Adress" type="text" width="200px" />
												</div>
											</div>
										</div>
										<!--/span-->
