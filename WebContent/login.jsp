...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<%-- <img src="<%=basePath%>media/image/CRM.png"> --%>
		<img src="<%=basePath%>media/image/颜屏LOGO.png" style="height:180px">
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="form-vertical login-form" action="hr_emp!login"
			method="post">
			<h3 class="form-title" style="text-align: center;">颜屏CRM管理系统登录</h3>
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-tag"></i> <input class="m-wrap placeholder-no-fix"
							type="text" placeholder="验证码" name="inpcode"
							style="width: 100px;" />
	...
	<!-- END LOGIN -->
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">2019 &copy; 【子戈信息】 - CRM客户管理系统</div>
	<!-- END COPYRIGHT -->
