										...
										<tr class="">
											...
											<td>
												<s:if test="#p.ad_State==0">
													<a onclick="return confirm('是否要禁用该广告?');" data-toggle="modal" href="pub_Ad!updateAdvertPicState?publicAdvert.ad_Id=<s:property value="#p.ad_Id" />&&publicAdvert.ad_State=1 "><i class="icon-adjust"></i>运行中</a>
												</s:if>
												<s:if test="#p.ad_State==1">
	                                               <a onclick="return confirm('是否要重新启用该广告?');" data-toggle="modal" href="pub_Ad!updateAdvertPicState?publicAdvert.ad_Id=<s:property value="#p.ad_Id" />&&publicAdvert.ad_State=0"><i class="icon-remove"></i>已禁用</a>
												</s:if>
											</td>
											...
											<%-- <td>
												...
												<div class="btn-group" style="margin-bottom: 0px !important;">
													...
													<ul class="dropdown-menu">
														...
														<li><a onclick="return confirm('确定删除该条广告吗?');" href="pub_Ad!deleteAdvertPic?id=<s:property value="#p.ad_Id" />">
