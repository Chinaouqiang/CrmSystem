						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="btn-group" style="margin-bottom: 0px !important;">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="pub_Ad!AdvertManageHead?publicAdvert.Device_only=<s:property value="#Only"/>">
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_2">
									...
									<tbody>									
										<s:iterator value="#AdvertManage" var="p">
										<tr class="">
											...
											<td>
												...
												<div class="btn-group" style="margin-bottom: 0px !important;">
													...
													<ul class="dropdown-menu">
														...
														<li><a onclick="return confirm('确定删除该条广告吗?');" href="pub_Ad!deleteAdvertVido?id=<s:property value="#p.ad_Id" />&&publicAdvert.Device_only=<s:property value="#p.Device_only" />">
