					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="#">CRM部门管理</a>
								...
								<i class="icon-angle-right"></i><a href="#">广告视频类型修改</a></li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>修改广告视频类型信息
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="pub_Ad!updateAdvertVido" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
    												<input type="file" onchange="checkTv()" name="upload" id="movie_tv" value="<s:property value="#listOnead.ad_PicTure" />"/>
												</div>
											</div>
										</div>
									</div>
