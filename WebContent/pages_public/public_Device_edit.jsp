			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- END 风格定制 -->
						<!-- BEGIN 网页的标题和面包屑-->
						<h3 class="page-title">设备<small>修改设备信息</small></h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="#">CRM部门管理</a>
								<i class="icon-angle-right"></i> <a href="#">产品管理</a> 
								<i class="icon-angle-right"></i> <a href="pub_Ad!findAllAdvert">终端设备管理</a>
								<i class="icon-angle-right"></i><a href="#">设备信息修改</a></li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>修改设备信息
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="Device!updateDevice" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
												<input name="device.Device_Id" type="hidden" width="200px" value="<s:property value="#deviceOne.Device_Id" />" />
												<input name="device.BranchShop_Id" type="hidden" width="200px" value="<s:property value="#deviceOne.BranchShop_Id" />" />
												<input name="device.Device_State" type="hidden" width="200px" value="<s:property value="#deviceOne.Device_State" />" />
												<input name="device.Device_Name" type="text" width="200px" value="<s:property value="#deviceOne.Device_Name" />" />
												</div>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												<label class="control-label">终端地点：</label>
												<div class="controls">
														<input name="device.Device_Address" type="text" width="200px" value="<s:property value="#deviceOne.Device_Address" />" />
												</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												<label class="control-label">终端序列号：</label>
												<div class="controls">
    												<input name="device.Device_Only" type="text" width="200px" value="<s:property value="#deviceOne.Device_Only" />"/>
												</div>
											</div>
										</div>
									</div>
