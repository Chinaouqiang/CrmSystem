					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="#">CRM部门管理</a>
								...
								<i class="icon-angle-right"></i><a href="#">标题提示广告添加</a></li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
												<input type="hidden" name="publicAdvert.Device_only" value="<s:property value="#OnlyHead" />">
