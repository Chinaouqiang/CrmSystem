					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>添加广告信息(图片)
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="pub_Ad!addPicAdvert" method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
												<input type="hidden" name="publicAdvert.Device_only" value="<s:property value="#OnlyPic" />">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
    												<input type="file" name="upload" id="movie_img" onchange="checkImg()"/>
												</div>
											</div>
										</div>
									</div>
