			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- END 风格定制 -->
						<!-- BEGIN 网页的标题和面包屑-->
						<h3 class="page-title">设备<small>添加设备信息</small></h3>
						<ul class="breadcrumb">
							<li><i class="icon-home"></i> <a href="#">CRM部门管理</a>
								...
								<i class="icon-angle-right"></i><a href="#">设备信息添加</a></li>
						</ul>
						<!-- END 网页的标题和面包屑-->
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>添加设备信息
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="Device!addDevice" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
												<input name="device.Device_Name" type="text" width="200px" />
												</div>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
														<input name="device.Device_Address" type="text" width="200px" />
												</div>
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
    												<input name="device.Device_Only" id="movie_img" onchange="checkImg()"/>
												</div>
											</div>
										</div>
									</div>
