					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i>添加摄像数据
								</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="backMonitor!addBackMonitor" method="post" class="form-horizontal">
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="backMonitor.B_Only" type="text" width="200px" />
												</div>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row-fluid">
										<div class="span6 ">
											<div class="control-group">
												...
												<div class="controls">
													<input name="backMonitor.B_CheckCode" type="text" width="200px" />
												</div>
											</div>
										</div>
									</div>
