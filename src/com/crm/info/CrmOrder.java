...
public class CrmOrder implements java.io.Serializable {
	...
	public CrmOrder(CrmCustomer crmCustomer, HrEmployee hrEmployeeByCreateId,
			...
			Timestamp orderDate, String orderDetails, Double orderAmount,
			Timestamp createDate, Double receiveMoney, Double arrearsMoney,
			Double invoiceMoney, Double arrearsInvoice, Integer isdelete,
			Timestamp deleteTime, Set crmReceives, Set crmOrderDetailses,
			Set crmInvoices) {
