...
public class CrmCustomer implements java.io.Serializable {
	...
	public CrmCustomer(HrEmployee hrEmployeeByEmployeeId,
			...
			Timestamp lastfollow, Timestamp createDate, Integer isdelete,
			Timestamp deleteTime, Set crmContacts, Set crmContracts,
	...
	public Timestamp getLastfollow() {
		return this.lastfollow;
	}

	public void setLastfollow(Timestamp lastfollow) {
		this.lastfollow = lastfollow;
	}
