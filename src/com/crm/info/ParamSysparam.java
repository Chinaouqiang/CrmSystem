...
public class ParamSysparam implements java.io.Serializable {
	...
	public ParamSysparam(HrEmployee hrEmployeeByCreateId,
			...
			String paramsOrder, Timestamp createDate, Timestamp updateDate,
	...
	public String toString() {
		return "ParamSysparam [id=" + id + ", hrEmployeeByCreateId=" + hrEmployeeByCreateId + ", paramSysparamType="
				+ paramSysparamType + ", hrEmployeeByUpdateId=" + hrEmployeeByUpdateId + ", paramsName=" + paramsName
				+ ", paramsOrder=" + paramsOrder + ", createDate=" + createDate + ", updateDate=" + updateDate
				+ ", crmReceivesForReceiveTypeId=" + crmReceivesForReceiveTypeId + ", crmReceivesForReceiveDirectionId="
				+ crmReceivesForReceiveDirectionId + ", hrPositions=" + hrPositions + ", hrEmployees=" + hrEmployees
				+ ", mailFlowsForReciveTypeId=" + mailFlowsForReciveTypeId + ", mailFlowsForImportant="
				+ mailFlowsForImportant + ", crmCustomersForCustomerindustryId=" + crmCustomersForCustomerindustryId
				+ ", crmOrdersForOrderStatusId=" + crmOrdersForOrderStatusId + ", crmCustomersForCustomersourceId="
				+ crmCustomersForCustomersourceId + ", crmCustomersForCustomerlevelId=" + crmCustomersForCustomerlevelId
				+ ", crmCustomersForCustomertypeId=" + crmCustomersForCustomertypeId + ", crmFollows=" + crmFollows
				+ ", crmOrdersForPayTypeId=" + crmOrdersForPayTypeId + ", hrDepartmentsForDIconId="
				+ hrDepartmentsForDIconId + ", crmInvoices=" + crmInvoices + ", hrDepartmentsForDTypeId="
				+ hrDepartmentsForDTypeId + "]";
	}
